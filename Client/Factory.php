...
/**
 * @mixin \QuantaQuirk\Http\Client\PendingRequest
 */
class Factory
{
    use Macroable {
     ...
     * @return \QuantaQuirk\Http\Client\ResponseSequence
     */
     ...
     *
     * @param  string  $url
     * @param  \QuantaQuirk\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable  $callback
     * @return $this
     */
     ...
     *
     * @return \QuantaQuirk\Contracts\Events\Dispatcher|null
     */
