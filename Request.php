...
namespace QuantaQuirk\Http;

use ArrayAccess;
use Closure;
use QuantaQuirk\Contracts\Support\Arrayable;
use QuantaQuirk\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new QuantaQuirk HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using QuantaQuirk.
     *
    ...
    /**
     * Create a new request instance from the given QuantaQuirk request.
     *
     * @param  \QuantaQuirk\Http\Request  $from
     * @param  \QuantaQuirk\Http\Request|null  $to
     * @return static
     */
    ...
    /**
     * Create an QuantaQuirk request from a Symfony instance.
     *
     ...
     * @return void
     */
    public function setQuantaQuirkSession($session)
    {
     ...
     * @param  mixed  $default
     * @return \QuantaQuirk\Routing\Route|object|string|null
     */
